...
<template>
    <Head title="Create Account — ClinicOS" />
    ...
    <div class="auth-root">
        ...
        <aside class="left-panel">
            ...
            <div class="left-content">
                ...
                <div class="left-hero">
                    <h1 class="left-title">Join <em>ClinicOS</em></h1>
                    <p class="left-sub">
                        Create your account and start managing your clinic efficiently.
                        One platform for patients, appointments, billing, and more.
                    </p>
                </div>
        ...
        <main class="right-panel">
            <div class="top-bar">
                ...
                <span class="need-help">Already have an account? <Link :href="route('login')">Sign In</Link></span>
            </div>
            ...
            <div class="form-card">
                <div class="form-header">
                    ...
                    <p class="form-subtitle">Join ClinicOS to manage your clinic</p>
                </div>
                ...
                <form @submit.prevent="submit" class="form-body" novalidate>
                    ...
                    <div class="field-group"
                        :class="{ focused: nameFocused, filled: form.name, error: form.errors.name }">
                        <label for="name" class="field-label">Full Name <span class="required-star">*</span></label>
                        <div class="field-wrap">
                            ...
                            <input id="name" v-model="form.name" type="text" autocomplete="name"
                                placeholder="Dr. John Doe" class="field-input" @focus="nameFocused = true"
                                @blur="nameFocused = false" required />
                        </div>
                    ...
                    <div class="field-group"
                        ...
                        <div class="field-wrap">
                            ...
                            <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'"
                                autocomplete="new-password" placeholder="Create a strong password" class="field-input"
                    ...
                    <!-- Confirm Password -->
                    <div class="field-group"
                        :class="{ focused: confirmFocused, filled: form.password_confirmation, valid: passwordsMatch && form.password_confirmation.length > 0, error: form.errors.password_confirmation }">
                        <label for="password_confirmation" class="field-label">Confirm Password <span class="required-star">*</span></label>
                        <div class="field-wrap">
                            <span class="field-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                            ...
                            <input id="password_confirmation" v-model="form.password_confirmation" :type="showConfirmPassword ? 'text' : 'password'"
                                autocomplete="new-password" placeholder="Confirm your password" class="field-input"
                                @focus="confirmFocused = true" @blur="confirmFocused = false" required />
                            <button type="button" class="pass-toggle" @click="showConfirmPassword = !showConfirmPassword"
                                :aria-label="showConfirmPassword ? 'Hide' : 'Show'" tabindex="0">
...
.form-title { font-family: var(--font-body); font-size: 26px; font-weight: 700; color: var(--text); letter-spacing: -0.7px; line-height: 1.2; }
...
.footer-copy a { color: var(--text3); text-decoration: none; transition: color 0.2s; }
