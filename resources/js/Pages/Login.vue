...
<template>
    ...
    <div class="auth-root">
        ...
        <main class="right-panel">
            <!-- Dark mode toggle -->
            <div class="top-bar">
                <button class="dark-toggle" id="darkToggleBtn" @click="$emit('toggle-dark')" type="button"
                ...
                <form @submit.prevent="submit" class="form-body" novalidate>
                    ...
                    <div class="field-group"
                        ...
                        <div class="field-wrap">
                            <span class="field-icon">
                                <!-- Envelope SVG (inline, no external) -->
                    ...
                    <div class="field-group"
                        ...
                        <div class="field-wrap">
                            ...
                            <!-- Show/hide password toggle — 100% inline SVG, no external resource -->
                        ...
                        <!-- Password strength meter (visible while typing) -->
...
/* By default show moon (light mode), hide sun */
.icon-sun {
    display: none;
}
...
/* Don't let that override transform transitions on interactive elements */
.submit-btn,
.dark-toggle,
.pass-toggle,
.checkbox-custom,
